...
| `STAGING_MONGO_URI_MG` / `STAGING_MONGO_URI_CG` / `STAGING_MONGO_URI_LOOPC` / `STAGING_MONGO_URI_VB` | Staging DB URIs for [provision-staging-smoke-credentials.yml](../.github/workflows/provision-staging-smoke-credentials.yml) |
