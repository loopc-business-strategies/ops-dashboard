# Nexa mobile — avoid EAS billing and queues

This doc is the **recommended default workflow** for the Nexa mobile app when you want **no Expo Application Services (EAS) build queue**, **no EAS Update (OTA) usage**, and **no dependency on Expo cloud** for day-to-day work.
