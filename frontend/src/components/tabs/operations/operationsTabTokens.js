...
export const OPS_BADGE_MAP = {
  ...
  'Under review': { bg: 'var(--brand-soft)', color: 'var(--brand-on-soft)', b: 'var(--brand-border)' },
  ...
  'Pending External': { bg: 'var(--brand-soft)', color: 'var(--brand-on-soft)', b: 'var(--brand-border)' },
  ...
  Air: { bg: 'var(--brand-soft)', color: 'var(--brand-on-soft)', b: 'var(--brand-border)' },
