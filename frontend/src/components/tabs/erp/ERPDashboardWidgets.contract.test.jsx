...
describe('ERPDashboardWidgets contract', () => {
  ...
  test('expenses card shows register without opening modal', () => {
    ...
    expect(screen.getByRole('button', { name: 'Download month report' })).toBeTruthy()
    expect(screen.getByRole('button', { name: 'Download month on month report' })).toBeTruthy()
  ...
  test('expense dashboard modal shows charts register and close', () => {
    ...
    expect(screen.getAllByRole('button', { name: 'Download month report' }).length).toBeGreaterThan(0)
    expect(screen.getAllByRole('button', { name: 'Download month on month report' }).length).toBeGreaterThan(0)
