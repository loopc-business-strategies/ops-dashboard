              ...
              <>
                ...
                <div style={{ padding:'30px 20px', background:C.sidebar, borderBottom:`1px solid ${C.border}`, display:'flex', alignItems:'center', gap:12, flexShrink:0 }}>
                  {activeChat.type === 'group' ? (
                    <div style={{ width:40, height:40, borderRadius:'50%', background:'rgba(var(--brand-rgb),0.08)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:18, flexShrink:0 }}>👥</div>
                  ) : (
                ...
                {/* Messages */}
                <div style={{ flex:1, overflowY:'auto', padding:'20px 18px', display:'flex', flexDirection:'column', gap:4, scrollbarWidth:'thin', scrollbarColor:`rgba(var(--brand-rgb),0.3) transparent` }}>
                ...
                <div style={{ padding:'12px 16px', background:C.inputBg, borderTop:`1px solid ${C.border}`, flexShrink:0 }}>
                  {chatTranslateEnabled && translatePanelOpen ? (
                    <div style={{ marginBottom:10, padding:'10px 12px', borderRadius:12, background:'var(--brand-soft)', border:'1px solid rgba(var(--brand-rgb),0.18)', direction:'ltr', unicodeBidi:'isolate' }}>
                      ...
                      <div style={{ display:'flex', alignItems:'center', gap:8, flexWrap:'wrap', marginBottom:10 }}>
                        <select
                          ...
                          style={{ height:34, borderRadius:999, border:'1px solid rgba(var(--brand-rgb),0.25)', background:'#fff', color:'#334155', fontSize:12, padding:'0 10px', maxWidth:130 }}
                        >
                        ...
                        <select
                          ...
                          style={{ height:34, borderRadius:999, border:'1px solid rgba(var(--brand-rgb),0.25)', background:'#fff', color:'#334155', fontSize:12, padding:'0 10px' }}
                        >
                        ...
                        <>
                          ...
                          <div style={{ display:'flex', gap:8, marginTop:8, flexWrap:'wrap' }}>
                            ...
                            <button
                              ...
                              style={{ padding:'6px 12px', borderRadius:999, border:'1px solid rgba(var(--brand-rgb),0.25)', background:'#fff', color:'#334155', fontSize:12, fontWeight:600, cursor:'pointer' }}
                            >
                  ...
                  <div style={{ display:'flex', alignItems:'center', gap:10 }}>
                    ...
                    {/* Input box */}
                    <div style={{ flex:1, display:'flex', alignItems:'center', background:'#f8f9fa', border:'1.5px solid rgba(var(--brand-rgb),0.2)', borderRadius:24, padding:'9px 16px', gap:8, transition:'border-color .2s' }}
                      onFocusCapture={e => e.currentTarget.style.borderColor = C.accent}
                      onBlurCapture={e  => e.currentTarget.style.borderColor = 'rgba(var(--brand-rgb),0.2)'}
                    >
                      <input
                        ref={inputRef}
                        type="text"
                    ...
                    <button
                      ...
                      style={{ width:40, height:40, borderRadius:'50%', background: msgText.trim() ? C.accent : 'rgba(var(--brand-rgb),0.3)', border:'none', cursor: msgText.trim() ? 'pointer' : 'not-allowed', display:'flex', alignItems:'center', justifyContent:'center', transition:'all .2s', flexShrink:0 }}
                      onMouseEnter={e => { if (msgText.trim()) { e.currentTarget.style.background=C.accent2; e.currentTarget.style.transform='scale(1.06)' }}}
                      onMouseLeave={e => { e.currentTarget.style.background = msgText.trim() ? C.accent : 'rgba(var(--brand-rgb),0.3)'; e.currentTarget.style.transform='scale(1)' }}
                    >
                      <IconSend />
                    </button>
                  </div>
