        ...
        <div style={{ maxWidth: '735px', margin: '0 auto', fontSize: '11px', color: '#111111', pageBreakInside: 'avoid' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 170px', gap: '18px', alignItems: 'start', marginBottom: '8px' }}>
            ...
            <div style={{ textAlign: 'center' }}>
              {mgLogoImage ? (
                <img src={mgLogoImage} alt="Modern Gold Jewelry" style={{ width: '136px', height: '136px', objectFit: 'contain' }} />
              ) : null}
            </div>
          </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed', fontSize: '11px', marginBottom: '8px' }}>
            <thead>
              <tr style={{ background: '#F3F4F6' }}>
                ...
                <th style={{ border: '1.5px solid #111827', padding: '6px 4px', width: '126px' }}>{printAmountLabel}</th>
              </tr>
            </thead>
            <tbody>
              {(mgLineItems.length ? mgLineItems : [mgPrimaryLine]).map((line, idx) => (
                <tr key={`mg-print-line-${idx}`} style={{ height: mgLineItems.length <= 1 ? '150px' : '42px' }}>
                  <td style={{ border: '1.5px solid #111827', padding: '7px 5px', textAlign: 'center', verticalAlign: 'top' }}>{idx + 1}</td>
                  <td style={{ border: '1.5px solid #111827', padding: '7px 5px', verticalAlign: 'top' }}>{line?.branch || mgBranch}</td>
                  <td style={{ border: '1.5px solid #111827', padding: '7px 10px', verticalAlign: 'top' }}>{mgAccountDescription(line)}</td>
              ...
              <tr>
                <td colSpan={3} style={{ border: '1.5px solid #111827', padding: '6px 6px' }}>({mgLineItems.length || 1} Record)</td>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '235px 1fr', border: '1.5px solid #111827', minHeight: '30px', alignItems: 'center', marginBottom: '9px' }}>
            ...
            <div style={{ padding: '6px 10px', fontStyle: 'italic' }}>{mgAmountWords}</div>
          </div>
