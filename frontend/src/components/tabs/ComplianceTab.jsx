  ...
  return (
    <ModuleTabColumn style={{ fontFamily: 'inherit' }}>
      <ModulePageHeading
        ...
        right={(
          <div style={{ background: readOnlyByRole ? 'rgba(148,163,184,0.18)' : 'rgba(var(--brand-rgb),0.12)', color: readOnlyByRole ? '#556273' : C.primary, border: `1px solid ${readOnlyByRole ? 'rgba(100,116,139,0.3)' : C.borderStrong}`, borderRadius: 999, padding: '6px 11px', fontSize: 12, fontWeight: 700 }}>
        ...
        <Card>
          ...
          <div style={{ overflow: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12, minWidth: 860 }}>
              <thead><tr style={{ background: 'rgba(var(--brand-rgb),0.06)' }}><th style={th}>Entity</th><th style={th}>Permit</th><th style={th}>Status</th><th style={th}>Last Review</th><th style={th}>Owner</th><th style={th}>Notes</th><th style={th}>Actions</th></tr></thead>
              <tbody>
                {eligibility.map(r => (
        ...
        <Card>
          ...
          <div style={{ overflow: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12, minWidth: 900 }}>
              <thead><tr style={{ background: 'rgba(var(--brand-rgb),0.06)' }}><th style={th}>Authority</th><th style={th}>Filing</th><th style={th}>Due</th><th style={th}>Submitted</th><th style={th}>Status</th><th style={th}>Reference</th><th style={th}>Actions</th></tr></thead>
              <tbody>
                {approvals.map(r => (
                  <tr key={r.id}>
      ...
      {tab === 'docs' && (
        <Card>
          ...
          <div style={{ overflow: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12, minWidth: 900 }}>
              <thead><tr style={{ background: 'rgba(var(--brand-rgb),0.06)' }}><th style={th}>Document</th><th style={th}>Category</th><th style={th}>Owner</th><th style={th}>Version</th><th style={th}>Expiry</th><th style={th}>Status</th><th style={th}>Actions</th></tr></thead>
              <tbody>
                {docs.map(r => (
                  <tr key={r.id}>
        ...
        <Card>
          ...
          <div style={{ overflow: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12, minWidth: 960 }}>
              <thead><tr style={{ background: 'rgba(var(--brand-rgb),0.06)' }}><th style={th}>Title</th><th style={th}>Source</th><th style={th}>Effective</th><th style={th}>Impact</th><th style={th}>Owner</th><th style={th}>Status</th><th style={th}>Actions</th></tr></thead>
              <tbody>
                {updates.map(r => (
      ...
      {tab === 'agreements' && (
        <Card>
          ...
          <div style={{ overflow: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12, minWidth: 960 }}>
              <thead><tr style={{ background: 'rgba(var(--brand-rgb),0.06)' }}><th style={th}>Partner</th><th style={th}>Type</th><th style={th}>Start</th><th style={th}>End</th><th style={th}>Value</th><th style={th}>Status</th><th style={th}>Actions</th></tr></thead>
              <tbody>
                {agreements.map(r => (
                  <tr key={r.id}>
