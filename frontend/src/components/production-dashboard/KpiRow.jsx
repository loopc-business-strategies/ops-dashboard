  ...
  return (
    <section className="pd-kpi-row-grid" aria-label="Production KPIs">
      ...
      <KpiCard title="Total Production Today">
        <Row label="Processed Qty" value={productionTodayKpi.processedQty != null ? formatGrams(productionTodayKpi.processedQty) : 'No production data'} />
        <Row label="Production Weight" value={productionTodayKpi.productionWeight != null ? formatGrams(productionTodayKpi.productionWeight) : '—'} />
        <Row
      ...
      <KpiCard title="Under Production">
        <Row label="Active Batches" value={underProductionKpi.activeBatches != null ? underProductionKpi.activeBatches : 'No active batches'} />
        <Row label="Pending Quantity" value={underProductionKpi.pendingQuantity != null ? underProductionKpi.pendingQuantity : '—'} />
        <Row label="Remaining Weight" value={underProductionKpi.remainingWeight != null ? formatGrams(underProductionKpi.remainingWeight) : 'Weight pending'} />
        <Row
