#!/usr/bin/env node
/**
 * Phase 3 checklist — run after Atlas M10+ Cloud Backup is enabled on MG, CG, LoopC, Venus Bullion.
...
console.log('Before flipping to strict (per Atlas project: MG, CG, LoopC, Venus Bullion):')
...
const atlasKeys = ['ATLAS_PUBLIC_KEY', 'ATLAS_PRIVATE_KEY', 'ATLAS_GROUP_ID_MG', 'ATLAS_GROUP_ID_CG', 'ATLAS_GROUP_ID_LOOPC', 'ATLAS_GROUP_ID_VB']
