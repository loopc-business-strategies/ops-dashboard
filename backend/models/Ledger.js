...
const ledgerSchema = new mongoose.Schema(
  {
    ...
    referenceType: { type: String, enum: ['expense', 'invoice', 'payment', 'purchase', 'vendor_payment', 'journal', 'inventory', 'payroll', 'sale', 'receipt', 'metal_receipt', 'metal_payment', 'metal_transfer', 'cogs', 'reversal', 'direct_deal', 'vat_input', 'vat_output', 'bank_jv'], default: 'journal' },
...
ledgerSchema.index({ isDeleted: 1, debitAccountId: 1, date: -1, createdAt: -1 })
ledgerSchema.index({ isDeleted: 1, creditAccountId: 1, date: -1, createdAt: -1 })
ledgerSchema.index({ isDeleted: 1, referenceId: 1 })
ledgerSchema.index({ isDeleted: 1, date: 1 })
ledgerSchema.index({ isDeleted: 1, referenceType: 1, date: -1, _id: -1 })
ledgerSchema.index({ isDeleted: 1, date: -1, _id: -1 })
