...
const integrationsSalesAiRoutes = require('./routes/integrationsSalesAi')
...
function createApp() {
  ...
  app.use('/api/approvals', require('./routes/approvalPolicy'))
  app.use('/api/customer-360', require('./routes/customer360'))
  app.use('/api/exceptions', require('./routes/ownerExceptions'))
